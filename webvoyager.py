...
# async def login(state: AgentState):
#     """
#     Automates the login process by manually entering credentials.
#     """
#     page = state["page"]
#     login = await login(state)
...
#     try:
#         await page.fill("input[name='username']", username)  # Username field
...
async def main(keyword="github"):
    async with async_playwright() as p:
        if keyword == "github":
            ...
            prompt = """1.Login to https://anishadesai-ta.github.io/companydemo/ login with admin as username and password123 as password .
